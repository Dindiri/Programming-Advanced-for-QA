...
public class SongTests
{
    ...
    public void Test_AddAndListSongs_ReturnsFilteredSongs_WhenWantedListIsSpecific()
    {
        ...
        //Assert
        Assert.That(result, Is.EqualTo(expected), "Actual result is not equal to expected result.");
    }
    ...
    public void Test_AddAndListSongs_ReturnsEmptyString_WhenNoSongsMatchWantedList()
    {
        ...
        // Act
        string result = _song.AddAndListSongs(songs, "PopFolk");

        //Assert
        Assert.That(result, Is.Empty, "The result is not empty string.");
    }
}
